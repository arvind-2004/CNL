...
{     
      if(head==NULL)
          { 
           ...
           {    cout<<"\n how many chapters you want to insert"<<endl;
                cin>>n;
                for(i=0;i<n;i++)
                {
                t1=create();
         ...
         if(head==NULL)
          { 
           ...
           {    cout<<"\n Enter the name of chapter on which  you want to enter the section"<<endl;
                 ...
                 temp=head;
               if(temp->flag==0)
               {   cout<<"\n their are no chapters on in book"<<endl;
               }
               else
               {    temp=temp->down;
                while(temp!=NULL)
                 { 
                      ...
                      {   
                                cout<<"\n how many sections you want to enter"<<endl;
                                cin>>n;
                                for(i=0;i<n;i++)
                                {
                           ...
                           {     cout<<"\n\t\tNAME OF CHAPTER:  "<<temp->name<<endl;
                                 ...
                                 {  t1=t1->down;
                                    ...
                                    {     cout<<"\n\t\t\t\tNAME OF SECTION:  "<<t1->name<<endl;
                                          ...
                                          {  t2=t2->down;
                                          while(t2!=NULL)
                                          {     cout<<"\n\t\t\t\t\t\tNAME OF SUBSECTION:  "<<t2->name<<endl;     
                                          t2=t2->next;
                                          }
                                          }     
                                          t1=t1->next;
